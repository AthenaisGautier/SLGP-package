...
```{r SLGPplotting1, fig.cap = "Figure 2: Predictive probability density of medv at age, as predicted by a SLGP.", fig.fullwidth=TRUE, fig.height=6, fig.width=8, fig.align='center',fig.pos="H"}
library(SLGP)
library(viridis)
...
```{r SLGPplotting2, fig.cap = "Figure 3: Predictive probability density of medv at age, seen over slices.", fig.fullwidth=TRUE, fig.height=6, fig.width=8, fig.align='center',fig.pos="H"}
library(SLGP)
library(viridis)
...
```{r SLGPLaplaceplot, fig.cap = "Figure 4: Predictive probability density (and draws from a Laplace approximation) of medv at age, seen over 3 slices.", fig.fullwidth=TRUE, fig.height=6, fig.width=8, fig.align='center',fig.pos="H"}
...
```{r SLGPMCMCplot, fig.cap = "Figure 5: Predictive probability density (and draws from a MCMC) of medv at age, seen over 3 slices.", fig.fullwidth=TRUE, fig.height=6, fig.width=8, fig.align='center',fig.pos="H"}
# Define the three selected values
